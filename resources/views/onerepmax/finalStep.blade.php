<x-layout>
    ...
    <div class="flex flex-col items-center justify-center">
        ...
        <div class="flex w-full flex-col items-center p-3 justify-center bg-white shadow-md rounded-xl mt-3">
            <div class="overflow-x-auto w-full">
                <table class="table-auto text-center hidden sm:table">
                    <thead>
                        <tr class="bg-blue-gray-100 text-sm sm:text-base text-gray-700">
        ...
        @unless ($compound->id === 4)
            <div class="sm:w-full flex flex-col items-center p-3 justify-center bg-white shadow-md rounded-xl mt-3">
